...
detect_model = 'models/detector_model.hdf5'
recognize_model = 'models/recognize_model.hdf5'
...
def recognizer(img_files):
    ...
    for img_file in img_files:
        # 2. image
        predictions.append(digit_spotter.run(img_file, threshold=0.5, do_nms=True, nms_threshold=0.1,show_result=False))
